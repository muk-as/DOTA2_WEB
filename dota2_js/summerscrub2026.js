...
(self.webpackChunkdota_react = self.webpackChunkdota_react || []).push([
  [65868],
  {
    ...
    65868: (s, e, i) => {
      "use strict";
      i.r(e), i.d(e, { InfoIcon: () => N, default: () => D });
      var a = i(85608),
        r = i(69500),
        m = i(89506),
        n = i(33706),
      ...
      const N = () =>
          (0, r.jsx)("div", {
            ...
            style: { backgroundImage: `url( ${m.r.IMG_URL}/icons/info.svg )` },
          }),
        I = (s) =>
          (0, r.jsxs)("div", {
            className: s
              ? (0, o.A)(p().SectionDivider, s)
              : (0, o.A)(p().SectionDivider),
            children: [
              (0, r.jsx)("div", { className: p().Pattern }),
              (0, r.jsx)("div", { className: p().Overlay }),
              (0, r.jsx)("div", { className: p().TopDash }),
              (0, r.jsx)("div", { className: p().BottomDash }),
            ],
          }),
        C = () =>
          (0, r.jsxs)("div", {
            ...
            children: [
              (0, r.jsx)("div", { className: p().TopDash }),
              (0, r.jsx)("div", { className: p().Background }),
            ],
          }),
        y = (s) => {
          const e = (0, d.useRef)(void 0);
          return s.video
            ? (0, r.jsx)("video", {
                className: (0, o.A)(s.additionalClassName),
                ref: e,
                muted: !0,
                autoPlay: !0,
                preload: "auto",
                loop: !0,
                playsInline: !0,
                poster: `${m.r.IMG_URL}${s.image}`,
                children: (0, r.jsx)("source", {
                  type: "video/webm",
                  src: `${m.r.VIDEO_URL}${s.video}`,
                }),
              })
            : (0, r.jsx)("img", {
                className: (0, o.A)(s.additionalClassName),
                src: `${m.r.IMG_URL}/` + s.image,
              });
        },
        h = (s) =>
          (0, r.jsx)("div", {
            className: (0, o.A)(p().BugFix, s.additionalClassName),
            children: (0, r.jsx)("p", {
              className: (0, o.A)(p().BodyFont, p().BodyMedium),
              children: (0, t.Wn)(s.description),
            }),
          }),
        L = (0, c.PA)((s) => {
          const e = n.B5.Get().getHeroList();
          let i = e?.heroes.find((e) => e.id == s.nHeroID);
          const a = i?.name.replace("npc_dota_hero_", "");
          return (0, r.jsxs)("div", {
            className: (0, o.A)(p().HeroNameBlock, s.additionalClassName),
            children: [
              (0, r.jsx)("img", {
                className: p().HeroIcon,
                src: `${m.r.IMG_URL}heroes/icons/${a}.png`,
              }),
              (0, r.jsx)("p", {
                className: (0, o.A)(p().HeroName, p().BodyFont, p().BodySmall),
                children: i?.name_loc,
              }),
            ],
          });
      ...
      let H = class extends d.Component {
        convertAbilityDesc(s) {
          if (!s) return null;
          let e = s.desc_loc;
          return (
            s.special_values.forEach((s) => {
              let i =
                s.values_float.length > 0 ? (0, f.F)(s.values_float[0]) : "0";
              (e = e.replace("%" + s.name + "%", i)),
                (e = e.replace("%" + s.name.toLowerCase() + "%", i));
            }),
            (e = e.replace(/\%\%/g, "%")),
            (e = e.replace(/<h2>/g, "<b>")),
            (e = e.replace(/<\/h2>/g, "</b>")),
        ...
        render() {
          const s = l.o.getPatchNotes("7.41e", m.r.LANGUAGE);
          let e = (0, _.wwZ)((0, _.sfN)(m.r.LANGUAGE));
          return (
            "zh-cn" === e ? (e = "zh-Hans") : "zh-tw" === e && (e = "zh-Hant"),
            (0, r.jsxs)("div", {
              id: "Summerscrub2026",
              className: p().Summerscrub2026,
              children: [
                (0, r.jsx)(u.mg, {
                  children: (0, r.jsx)("title", {
                    children: (0, t.Wn)("#summerscrub2026_website_stub"),
                  }),
                }),
                (0, r.jsxs)("div", {
                  className: (0, o.A)(p().PageContainer),
                  children: [
                    (0, r.jsx)(x.A, { bOverlapping: !0 }),
                    (0, r.jsx)("div", {
                      className: (0, o.A)(p().HeaderGradient),
                    }),
                    (0, r.jsxs)("div", {
                      className: (0, o.A)(
                        p().WebsiteSection,
                        p().ImprovementsSection,
                      ),
                      children: [
                        (0, r.jsx)(y, {
                          image: "summerscrub2026/header_image.png",
                          additionalClassName: (0, o.A)(p().HeaderImage),
                        }),
                        (0, r.jsxs)("div", {
                          className: p().WebsiteSectionInner,
                          children: [
                            (0, r.jsxs)("div", {
                              className: (0, o.A)(p().HeaderTextSection),
                              children: [
                                (0, r.jsx)("p", {
                                  className: (0, o.A)(
                                    p().WebsiteTitle,
                            ...
                            (0, r.jsx)("div", { className: p().SectionSpacer }),
                            C(),
                            (0, r.jsx)("div", { className: p().SectionSpacer }),
                            (0, r.jsxs)("div", {
                            ...
                            (0, r.jsxs)("div", {
                              className: p().PostGameBreakdownsImageContainer,
                              children: [
                                (0, r.jsx)(y, {
                                  image:
                                    "summerscrub2026/post-game-breakdowns-background.jpg",
                                  additionalClassName:
                                    p().PostGameBreakdownsImageBackground,
                                }),
                                (0, r.jsx)(y, {
                                  image:
                                    "summerscrub2026/post-game-breakdowns.png",
                                  additionalClassName:
                                    p().PostGameBreakdownsImage,
                                }),
                              ],
                            }),
                            (0, r.jsxs)("div", {
                              ...
                              children: [
                                (0, r.jsx)("div", {
                                  className: p().TextImageBlockVertical,
                            ...
                            (0, r.jsx)(y, {
                              ...
                              additionalClassName: p().TimelineImage,
                            }),
                            (0, r.jsx)("p", {
                              className: (0, o.A)(
                                p().BlockDescription,
                            ...
                            (0, r.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, r.jsx)(y, {
                                  ...
                                  additionalClassName: p().HotKeysImage,
                                }),
                                (0, r.jsx)("p", {
                                  className: (0, o.A)(
                                    p().BlockDescription,
                                    p().HotKeysDescription,
                                    p().BodyFont,
                                    p().BodyLarge,
                                    p().LightGrayText,
                                  ),
                    ...
                    (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, r.jsxs)("div", {
                            className: (0, o.A)(p().BugfixListContainer),
                            children: [
                              (0, r.jsx)("p", {
                                className: (0, o.A)(
                                  p().BugFixCategoryTitle,
                                  p().LabelFont,
                                  p().LabelExtraLarge,
                                ),
                                children: (0, t.Wn)(
                              ...
                              (0, r.jsxs)("div", {
                                className: (0, o.A)(p().BugfixListColumn),
                                children: [
                                  (0, r.jsx)("p", {
                                    className: (0, o.A)(
                                      p().BugFixSubCategoryTitle,
                                      p().First,
                                      p().LabelFont,
                                      p().LabelMedium,
                                    ),
                                    children: (0, t.Wn)("#header_general"),
                                  }),
                                  (0, r.jsx)(h, {
                                    description:
                                  ...
                                  (0, r.jsx)("p", {
                                    ...
                                    children: (0, t.Wn)("#header_heroes"),
                                  }),
                                  (0, r.jsx)(L, {
                                    nHeroID: 38,
                                    additionalClassName: p().FirstHero,
                                  }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_3",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 62 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_6",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 78 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_60",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 99 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_7",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 61 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_8",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 81 }),
                                  (0, r.jsx)(h, {
                                    description:
                                  ...
                                  (0, r.jsx)(L, { nHeroID: 94 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_gameplay_bugfix_25",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 82 }),
                                  (0, r.jsx)(h, {
                                    description:
                            ...
                            children: [
                              ...
                              (0, r.jsxs)("div", {
                                ...
                                children: [
                                  ...
                                  (0, r.jsx)(L, { nHeroID: 31 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_cosmetics_bugfix_21",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 80 }),
                                  (0, r.jsx)(h, {
                                    description:
                                  ...
                                  (0, r.jsx)(L, { nHeroID: 12 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_cosmetics_bugfix_33",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 14 }),
                                  (0, r.jsx)(h, {
                                    description:
                                  ...
                                  (0, r.jsx)(L, { nHeroID: 79 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_cosmetics_bugfix_48",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 75 }),
                                  (0, r.jsx)(h, {
                                    description:
                                  ...
                                  (0, r.jsx)(L, { nHeroID: 29 }),
                                  (0, r.jsx)(h, {
                                    description:
                                      "#summerscrub2026_cosmetics_bugfix_64",
                                    additionalClassName: p().Indent1,
                                  }),
                                  (0, r.jsx)(L, { nHeroID: 19 }),
                                  (0, r.jsx)(h, {
                                    description:
                    ...
                    (0, r.jsx)("div", {
                      className: (0, o.A)(
                        p().WebsiteSection,
                        p().GameplayUpdateContainer,
                      ),
                      children: (0, r.jsxs)("div", {
                        className: p().WebsiteSectionInner,
                        children: [
                          (0, r.jsxs)("div", {
                            className: p().WebsiteSectionHeader,
                            children: [
                              (0, r.jsx)("p", {
                                className: (0, o.A)(
                                  p().SectionSubHeaderLabel,
                                  p().LabelFont,
                                  p().LabelMedium,
                                ),
                          ...
                          (0, r.jsx)("div", { className: p().SectionSpacer }),
                          (0, r.jsxs)("div", {
                            className: p().PatchnotesContainer,
                            children: [
                              (0, r.jsx)(j.fs, {
