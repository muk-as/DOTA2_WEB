  ...
  [3903],
  {
    ...
    33903: (e, a, t) => {
      ...
      const C = (0, s.PA)(({ patchnotes: e, heroname: a }) => {
          ...
          return l
            ? m.createElement(
                ...
                m.createElement(
                  ...
                  (0, i.Wn)("#new_frontiers_major_gameplay_hero_rework_" + a),
                ),
                m.createElement(
                  "div",
                  { className: N().HeroImageContainer },
                  m.createElement("div", { className: N().HeroShadow }),
                  m.createElement(S.sG, {
                    heroname: a,
                    portraitClassName: N().HeroReworkPortrait,
                    videoClassName: N().HeroReworkPortraitVideo,
                  }),
                ),
                m.createElement(
                  "div",
                  { className: N().HeroReworkPatchNotes },
                  m.createElement(u.fX, {
                    patchnotes: e,
                    heroname: a,
                    heroClassName: N().HeroReworkPatchNotesInner,
                  }),
                ),
              )
            : null;
        ...
        H = (0, s.PA)(({ name: e, components: a, recipeCost: t }) => {
          ...
          let d = c.special_values?.map((e, a) =>
            ...
            T = a
              ? a.map((e, a) =>
                  m.createElement("img", {
                    key: a,
                    className: N().RecipeComponentImage,
          ...
          return m.createElement(
            ...
            m.createElement(
              "div",
              { className: N().Body },
              m.createElement("div", { className: N().Stats }, d),
              o &&
                m.createElement(
                  "div",
                    ...
                    m.createElement(
                      ...
                      h &&
                        m.createElement(
                          ...
                          m.createElement("div", { className: N().ManaIcon }),
                          m.createElement(
                            "div",
                      ...
                      v &&
                        m.createElement(
                          ...
                          m.createElement("div", { className: N().HealthIcon }),
                          m.createElement(
                            "div",
        ...
        w = ({
          ...
          return (
            (0, m.useEffect)(() => {
              function a() {
                c && c.current && s.state.currentSlide == e
                  ? c.current.play()
                  : c && c.current && c.current.pause(),
                  s.state.currentSlide == e && i(t, l);
              }
            ...
            m.createElement(
              ...
              m.createElement(
                ...
                {
                  ref: c,
                  className: N().TreasureVideo,
                  muted: !0,
                  autoPlay: n,
                  preload: "auto",
                  loop: !0,
                  playsInline: !0,
                  poster: `${r.r.VIDEO_URL}/templatepage/treasure/${a}.png`,
                },
                m.createElement("source", {
                  type: "video/webm",
        ...
        R = (e) =>
          m.createElement(
            ...
            {
              className: e
                ? (0, p.A)(N().SectionDivider, e)
                : (0, p.A)(N().SectionDivider),
            },
            m.createElement("div", { className: N().Pattern }),
            m.createElement("div", { className: N().Overlay }),
        ...
        F = (e) =>
          m.createElement(
            ...
            m.createElement("div", { className: N().DashLeft }),
            m.createElement(
              "p",
              {
                className: (0, p.A)(N().LabelFont, N().LabelMedium, N().Label),
              },
              e.subHeader,
            ),
      ...
      let M = class extends m.Component {
        ...
        render() {
          const e = d.o.getPatchNotes("7.35", r.r.LANGUAGE),
            a =
              "schinese" == r.r.LANGUAGE || "tchinese" == r.r.LANGUAGE
                ? "ringmaster_trailer_schinese"
                : "ringmaster_trailer_english",
            t = n.B5.Get().getHeroData(131);
          let l = (0, o.ww)((0, o.sf)(r.r.LANGUAGE));
          "zh-cn" === l ? (l = "zh-Hans") : "zh-tw" === l && (l = "zh-Hant");
          let s = "templatepage_logo_en";
          return (
            ...
            m.createElement(
              ...
              m.createElement(
                "div",
                {
                  className: (0, p.A)(
                    N().TrailerContainer,
                    this.state.bPlayingVideo ? null : N().Hidden,
                  ),
                },
                m.createElement(
                  "video",
                  {
                    ref: this.videoRef,
                    className: (0, p.A)(N().TrailerVideo),
                    autoPlay: !1,
                    preload: "none",
                    muted: !1,
                    loop: !1,
              ...
              m.createElement(
                ...
                m.createElement(
                  "title",
                  null,
                  (0, i.Wn)("#templatepage_website_title"),
                ),
              ),
              m.createElement(
                "div",
                ...
                m.createElement(
                  "div",
                  { className: (0, p.A)(N().HeaderSection) },
                  m.createElement(
                    "div",
                    { className: (0, p.A)(N().LogoContainer) },
                    m.createElement("img", {
                      className: N().LogoImage,
                      src: `${r.r.IMG_URL}/templatepage/${s}.png`,
                    }),
                  ),
                  m.createElement(
                    "div",
                    { className: N().HeaderTextSection },
                    m.createElement(
                      "p",
                      {
                        className: (0, p.A)(
                    ...
                    m.createElement(
                      ...
                      (0, i.Wn)("#templatepage_website_introduction"),
                    ),
                  ),
                ),
                R(),
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_howitworks_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                ...
                m.createElement(
                  ...
                  m.createElement(
                    "div",
                    { className: N().WebsiteSectionInner },
                    m.createElement("div", { className: N().MobileOnlyIcon }),
                    m.createElement(
                      "p",
                      {
                        className: (0, p.A)(
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        {
                          className: (0, p.A)(
                            N().SectionSubHeaderLabel,
                            N().LabelFont,
                            N().LabelMedium,
                            N().GrayText,
                          ),
                        },
                        (0, i.Wn)("#templatepage_section_subheader"),
                      ),
                      m.createElement(
                        "h2",
                        {
                        ...
                        (0, i.Wn)("#templatepage_components_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                          className: (0, p.A)(
                            N().SectionDescriptionLabel,
                            N().DisplayFont,
                            N().DisplayMedium,
                            N().LightGrayText,
                          ),
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_newhero_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        "div",
                        { className: N().HeroAttributesContainer },
                        m.createElement("div", {
                          className: (0, p.A)(
                            N().HeroAttributeIcon,
                            N().Agility,
                        ...
                        m.createElement("div", {
                          className: (0, p.A)(N().HeroComplexityIcon),
                        }),
                      ),
                      m.createElement(
                        "div",
                        { className: N().HeroRolesContainer },
                        m.createElement(
                          "p",
                          {
                            className: (0, p.A)(
                          ...
                          (0, i.Wn)("#hero_attack_type_ranged"),
                        ),
                        m.createElement(
                          "p",
                          {
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_newhero_description"),
                      ),
                      m.createElement(
                        "div",
                ...
                m.createElement(
                  ...
                  m.createElement(
                        ...
                        m.createElement(
                          ...
                          m.createElement(
                            "video",
                            {
                              ...
                              loop: !0,
                              playsInline: !0,
                              poster: `${r.r.VIDEO_URL}/${e.posterDir}`,
                            },
                            e.videoSrcWebm &&
                              m.createElement("source", {
                                type: "video/webm",
                                src: `${r.r.VIDEO_URL}/${e.videoSrcWebm}`,
                              }),
                            e.videoSrcMp4 &&
                              m.createElement("source", {
                                type: "video/mp4",
                                src: `${r.r.VIDEO_URL}/${e.videoSrcMp4}`,
                              }),
                          ),
                          m.createElement(
                            "div",
                            { className: N().SlideAbilityInfoContainer },
                            m.createElement(
                              "div",
                              ...
                              m.createElement(
                                ...
                                t?.abilities.find((a) => a.id == e.abilityId)
                                  .name_loc,
                              ),
                              m.createElement(
                                "div",
                    ...
                    m.createElement(
                      "div",
                      { className: N().CarouselDotsSection },
                      m.createElement(
                        "div",
                        { className: N().CarouselDotsContainer },
                        m.createElement(
                          "p",
                          {
                            className: (0, p.A)(
                              N().CarouselDotsHeading,
                              N().LabelFont,
                              N().LabelLarge,
                            ),
                          },
                          (0, i.Wn)("#templatepage_abilities_heading"),
                        ),
                        m.createElement(
                          "div",
                          ...
                          G.map((e, a) =>
                            m.createElement(
                              y.cL,
                              {
                                ...
                                slide: a,
                                className: N().AbilitySelectorDot,
                              },
                              m.createElement(S.cT, {
                                heroData: t,
                                abilityData: t?.abilities.find(
                                  (a) => a.id == e.abilityId,
                                ),
                                bShowVideo: !1,
                                abilityHotKey: e.hotKey,
                                additionalClassName: N().HeroesAbility,
                                abilityType: N().Active,
                              }),
                            ),
                          ),
                        ),
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_wallpapers"),
                      ),
                    ),
                    m.createElement(
                      "div",
                      ...
                      m.createElement(
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper1.png` },
                          m.createElement(
                            "div",
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper2.png` },
                          m.createElement(
                            "div",
                            { className: N().Wallpaper },
                            m.createElement("img", {
                      ...
                      m.createElement(
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper3.png` },
                          m.createElement(
                            "div",
                            { className: N().Wallpaper },
                            m.createElement("img", {
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper4.png` },
                          m.createElement(
                            "div",
                            { className: N().Wallpaper },
                            m.createElement("img", {
                      ...
                      m.createElement(
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper5.png` },
                          m.createElement(
                            "div",
                            { className: N().Wallpaper },
                            m.createElement("img", {
                        ...
                        m.createElement(
                          "a",
                          { href: `${r.r.IMG_URL}/muerta/wallpaper6.png` },
                          m.createElement(
                            "div",
                            { className: N().Wallpaper },
                            m.createElement("img", {
                ...
                m.createElement(
                  "div",
                  {
                    ...
                    className: (0, p.A)(N().HeroDetailsSection),
                  },
                  m.createElement(
                    "div",
                    { className: N().HeroDetailsSectionInner },
                    m.createElement(
                      "div",
                      { className: N().TextBlock },
                      m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement("img", {
                        ...
                        src: `${r.r.IMG_URL}/heroes/crops/ringmaster.png`,
                      }),
                    ),
                  ),
                ),
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_treasure_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_treasure_section_description"),
                      ),
                    ),
                    m.createElement(
                      y.gi,
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)(this.state.treasureName),
                      ),
                      m.createElement(
                        "div",
                        ...
                        m.createElement(
                          ...
                          m.createElement("div", { className: N().NextArrow }),
                        ),
                      ),
                    ),
                    f(),
                    m.createElement(
                      ...
                      (0, i.Wn)("#templatepage_treasure_section_treasureinfo"),
                    ),
                    m.createElement(
                      "div",
                      { className: N().Grid_2 },
                      m.createElement(
                        ...
                        m.createElement("img", {
                          src: `${r.r.IMG_URL}/templatepage/image_1_1.png`,
                        }),
                        m.createElement(
                          "div",
                          { className: N().TextBlock },
                          ...
                          m.createElement(
                            ...
                            (0, i.Wn)("#templatepage_lipsum_medium"),
                          ),
                        ),
                      ),
                      m.createElement(
                        ...
                        m.createElement(
                          ...
                          m.createElement(
                            ...
                            (0, i.Wn)("#templatepage_treasure_section_keyname"),
                          ),
                          m.createElement(
                            "p",
                            {
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_typography_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("Title Extra Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().TitleLarge, N().TitleFont) },
                        (0, i.Wn)("Title Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().TitleMedium, N().TitleFont) },
                        (0, i.Wn)("Title Medium"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().TitleSmall, N().TitleFont) },
                        (0, i.Wn)("Title Small"),
                      ),
                      m.createElement(
                        "p",
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        "p",
                        {
                          className: (0, p.A)(N().BodyExtraLarge, N().BodyFont),
                        },
                        (0, i.Wn)("Body Extra Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().BodyLarge, N().BodyFont) },
                        (0, i.Wn)("Body Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().BodyMedium, N().BodyFont) },
                        (0, i.Wn)("Body Medium"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().BodySmall, N().BodyFont) },
                        (0, i.Wn)("Body Small"),
                      ),
                    ),
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("Label Extra Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().LabelLarge, N().LabelFont) },
                        (0, i.Wn)("Label Large"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().LabelMedium, N().LabelFont) },
                        (0, i.Wn)("Label Medium"),
                      ),
                      m.createElement(
                        "p",
                        { className: (0, p.A)(N().LabelSmall, N().LabelFont) },
                        (0, i.Wn)("Label Small"),
                      ),
                    ),
                  ),
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      ...
                      m.createElement(
                        ...
                        (0, i.Wn)("#templatepage_gameplay_section_subtitle"),
                      ),
                      m.createElement(
                        "h2",
                        {
                        ...
                        (0, i.Wn)("#templatepage_gameplay_section_title"),
                      ),
                      m.createElement(
                        "p",
                        {
                    ...
                    m.createElement(
                      "div",
                      { className: N().PatchnotesContainer },
                      m.createElement(u.fs, {
                        patchnotes: e?.general_notes,
                        headerClassName: N().PatchNotesHeaderLabel,
                        notesListClassName: N().PatchNotesList,
                      }),
                      m.createElement(u.wL, {
                        patchnotes: e?.neutral_creeps,
                        headerClassName: N().PatchNotesHeaderLabel,
                        notesListClassName: N().PatchNotesList,
                      }),
                      m.createElement(u.ZV, {
                        patchnotes: e?.items,
                        headerClassName: N().PatchNotesHeaderLabel,
                        notesListClassName: N().PatchNotesList,
                      }),
